//! Harness-neutral inference provider discovery, selection, and payer routing.
//!
//! Claude, Codex, Goose, Qoder, ACP, and Buzz setup all use this module. Each
//! harness command remains responsible only for its own process arguments and
//! environment.
