...
pub const DEVELOPER_COMMANDS: &[&str] = &["server", "gate", "catalog"];
...
Developers:
  \x1b[1mserver\x1b[0m:  Manage gateway demos, paywall specs, and subscription plans
  \x1b[1mgate\x1b[0m:    Gate APIs or local inference with stablecoin payments
